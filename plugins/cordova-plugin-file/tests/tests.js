    ...
    describe('File API', function () {
        ...
        describe('DirectoryReader interface', function () {
            describe("readEntries", function () {
                it("file.spec.37 should get contents of existing directory", function (done) {
                    var reader,
                ...
                it("file.spec.37.1 should get contents of existing directory", function (done) {
                ...
                it("file.spec.109 should return an empty entry list on the second call", function (done) {
                    ...
                    // Add a file to ensure the root directory is non-empty and then get the contents of the directory.
                    root.getFile(fileName, {
                        create : true
                    }, function (entry) {
                        reader = root.createReader();
            ...
            it("file.spec.38 should get contents of directory that has been removed", function (done) {
                ...
                root.getDirectory(dirName, {
                    ...
                    directory.removeRecursively(function () {
                        var reader = directory.createReader();
                        reader.readEntries(succeed.bind(null, done, 'reader.readEntries - Unexpected success callback, it should not get entries from deleted dir: ' + dirName), function (error) {
                            expect(error).toBeDefined();
                            expect(error).toBeFileError(FileError.NOT_FOUND_ERR);
                            root.getDirectory(dirName, {
                                create : false
        ...
        describe('Read method', function () {
            ...
            it("file.spec.83 should be able to get native blob objects", function (done) {
            ...
            function writeDummyFile(writeBinary, callback, done, fileContents) {
                ...
                // create a file, set to it, and get it in again
            ...
            it("file.spec.84 should get file properly, readAsText", function (done) {
            ...
            it("file.spec.84.1 should get JSON file properly, readAsText", function (done) {
            ...
            it("file.spec.85 should get file properly, Data URI", function (done) {
            ...
            it("file.spec.86 should get file properly, readAsBinaryString", function (done) {
                if (isIE) {
            ...
            it("file.spec.87 should get file properly, readAsArrayBuffer", function (done) {
            ...
            it("file.spec.88 should get sliced file: readAsText", function (done) {
                runReaderTest('readAsText', false, done, null, function (evt, fileData, fileDataAsBinaryString) {
                    expect(evt.target.result).toBe(fileDataAsBinaryString.slice(10, 40));
                    done();
                }, 10, 40);
            });
            it("file.spec.89 should get sliced file: slice past eof", function (done) {
                runReaderTest('readAsText', false, done, null, function (evt, fileData, fileDataAsBinaryString) {
                    expect(evt.target.result).toBe(fileData.slice(-5, 9999));
                    done();
                }, -5, 9999);
            });
            it("file.spec.90 should get sliced file: slice to eof", function (done) {
                runReaderTest('readAsText', false, done, null, function (evt, fileData, fileDataAsBinaryString) {
                    expect(evt.target.result).toBe(fileData.slice(-5));
                    done();
                }, -5);
            });
            it("file.spec.91 should get empty slice", function (done) {
                runReaderTest('readAsText', false, done, null, function (evt, fileData, fileDataAsBinaryString) {
                    expect(evt.target.result).toBe('');
                    done();
                }, 0, 0);
            });
            it("file.spec.92 should get sliced file properly, readAsDataURL", function (done) {
                runReaderTest('readAsDataURL', true, done, null, function (evt, fileData, fileDataAsBinaryString) {
                    /* `readAsDataURL` function is supported, but the mediatype in Chrome depends on entry name extension,
                        mediatype in IE is always empty (which is the same as `text-plain` according the specification),
                        the mediatype in Firefox is always `application/octet-stream`.
            ...
            it("file.spec.93 should get sliced file properly, readAsBinaryString", function (done) {
                if (isIE) {
                    /*`readAsBinaryString` function is not supported by IE and has not the stub.*/
                    pending();
                }
            ...
            it("file.spec.94 should get sliced file properly, readAsArrayBuffer", function (done) {
                // Skip test if ArrayBuffers are not supported (e.g.: Android 2.3).
                if (typeof window.ArrayBuffer == 'undefined') {
                    expect(true).toFailWithMessage('Platform does not supported this feature');
                    done();
            ...
            it("file.spec.94.5 should get large file in multiple chunks, readAsArrayBuffer", function (done) {
                // Skip test if ArrayBuffers are not supported (e.g.: Android 2.3).
                if (typeof window.ArrayBuffer == 'undefined') {
                    expect(true).toFailWithMessage('Platform does not supported this feature');
                    done();
                ...
                // Set the chunk size so that the get will take 5 chunks
            ...
            it("file.spec.94.6 should get large file in multiple chunks, readAsDataURL", function (done) {
                var largeText = "";
                for (var i = 0; i < 10; i++) {
                    largeText += "Test " + i + "\n";
                }
        ...
        describe('FileWriter', function () {
            ...
            it("file.spec.96 should be able to set and append to file, createWriter", function (done) {
                ...
                // create file, then set and append to it
            ...
            it("file.spec.97 should be able to set and append to file, File object", function (done) {
            ...
            it("file.spec.98 should be able to seek to the middle of the file and set more data than file.length", function (done) {
            ...
            it("file.spec.99 should be able to seek to the middle of the file and set less data than file.length", function (done) {
                if (isChrome) {
            ...
            it("file.spec.100 should be able to set XML data", function (done) {
                var fileName = "writer.xml", // file content
                content = '<?xml version="1.0" encoding="UTF-8"?>\n<test prop="ack">\nData\n</test>\n', // for testing file length
                length = content.length;
                // creates file, then set XML data
                createFile(fileName, function (fileEntry) {
                    fileEntry.createWriter(function (writer) {
                        //Verifier content
                        var verifier = function (evt) {
            ...
            it("file.spec.104 should be able to set binary data from an ArrayBuffer", function (done) {
                // Skip test if ArrayBuffers are not supported (e.g.: Android 2.3).
                if (typeof window.ArrayBuffer == 'undefined') {
                    expect(true).toFailWithMessage('Platform does not supported this feature');
                    done();
            ...
            it("file.spec.105 should be able to set binary data from a Blob", function (done) {
                // Skip test if Blobs are not supported (e.g.: Android 2.3).
            ...
            it("file.spec.106 should be able to set a File to a FileWriter", function (done) {
            ...
            it("file.spec.107 should be able to set a sliced File to a FileWriter", function (done) {
            ...
            it("file.spec.108 should be able to set binary data from a File", function (done) {
                // Skip test if Blobs are not supported (e.g.: Android 2.3).
        ...
        if (cordova.platformId == 'android') {
            ...
            // these tests ensure that you can get and copy from android_asset folder
