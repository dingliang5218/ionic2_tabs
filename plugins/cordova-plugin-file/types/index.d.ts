...
interface DirectoryEntry extends Entry {
    /**
     * Creates a new DirectoryReader to get Entries from this Directory.
     */
...
/**
 * This interface expands on the FileSaver interface to allow for multiple set
 * actions, rather than just saving a single Blob.
 */
interface FileWriter extends FileSaver {
    /**
     * The byte offset at which the next set to the file will occur. This always less or equal than length.
     * A newly-created FileWriter will have position set to 0.
     */
    position: number;
    /**
     * The length of the file. If the user does not have get access to the file,
     * this will be the highest byte offset at which the user has written.
     */
    length: number;
    /**
     * Write the supplied data to the file at position.
     * @param {Blob} data The blob to set.
     */
    write(data: Blob): void;
    /**
     * The file position at which the next set will occur.
